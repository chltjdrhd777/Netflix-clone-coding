...
export class TabDoor extends React.Component {
  render() {
    return (
      <svg
        ...
        focusable="true"
        version="1.1"
        style={{ fill: "grey", width: 35, height: 50 }}
      >
        <title />
...
export class TapDevices extends React.Component {
  render() {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        focusable="true"
        className="Devices"
        style={{ fill: "grey", width: 80, height: 50 }}
      >
        <title />
        <g id="devices">
          <path
...
export class TabPrice extends React.Component {
  render() {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        viewBox="0 0 63 48"
        focusable="true"
        style={{ fill: "grey", width: 50, height: 50 }}
      >
        <title />
        <g id="icon-price-tag">
          <path
